...
with st.form(key='measure_form'):
    ...
    ppm1 = st.number_input("pCO₂ [ppm] 標準ガス1", value=191)
    ppm2 = st.number_input("pCO₂ [ppm] 標準ガス2", value=568)
    ppm3 = st.number_input("pCO₂ [ppm] 標準ガス3", value=762)
    ppm4 = st.number_input("pCO₂ [ppm] 標準ガス4", value=1720)
